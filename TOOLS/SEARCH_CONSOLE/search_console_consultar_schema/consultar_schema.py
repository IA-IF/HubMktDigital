"""Consulta ao vivo o discovery document da API do Search Console --
recursos, metodos e parametros reais -- generalizando a necessidade de
uma tool por capacidade. Cacheado no Redis (o discovery document nao
muda entre chamadas).
"""
import json
import sys
...
CHAVE_CACHE = "search_console_schema:discovery"
...
def _consultar_schema_sem_cache() -> dict:
    ...
    recursos = {}
    for nome_recurso, recurso in desc.get("resources", {}).items():
        metodos = {}
