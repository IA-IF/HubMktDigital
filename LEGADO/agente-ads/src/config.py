...
# SITE seleciona qual SITES/<site>/.env e CLAUDE.<site>.md carregar
# (ex: SITE=3gfoods). Sem SITE, usa "integrafoods" (o site original) —
# nunca um .env/CLAUDE.md sem nome. Credenciais comuns (OAuth client, LLM,
# Telegram) vem do .env compartilhado na raiz do projeto; so o que e unico
# do site (customer ID, property ID, ...) fica em SITES/<site>/.env.
