...
Chamadas ao LLM passam pelo llm_router (REDIS/llm_router) em vez do SDK
...
# llm_router nao e um subpacote deste modulo (mora em REDIS/llm_router,
# fora de AGENTES/julio) — este projeto nao usa setup.py/pyproject, entao
# adicionamos o caminho manualmente antes do import.
