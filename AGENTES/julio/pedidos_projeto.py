"""Pedidos de mudanca/funcionalidade no PROPRIO projeto, chamado pelo
Julio (orchestrator.py) via tool `registrar_pedido_projeto` quando o
pedido e sobre o HubMktDigital em si -- nao sobre marketing de site.
