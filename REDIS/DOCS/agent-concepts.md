...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"core-agent-architecture","title":"Core agent architecture"},{"id":"the-agent-processing-cycle","title":"The agent processing cycle"}],"id":"how-ai-agents-work","title":"How AI agents work"},{"children":[{"id":"redis-powers-every-part-of-your-agent","title":"Redis powers every part of your agent"},{"id":"key-advantages","title":"Key advantages"}],"id":"why-redis-powers-ai-agents","title":"Why Redis powers AI agents"},{"id":"types-of-agents-you-can-build","title":"Types of agents you can build"},{"children":[{"id":"single-agent-systems","title":"Single-agent systems"},{"id":"multi-agent-systems","title":"Multi-agent systems"},{"id":"hierarchical-agents","title":"Hierarchical agents"}],"id":"agent-architecture-patterns","title":"Agent architecture patterns"},{"children":[{"id":"redis-streams-for-conversation-history","title":"Redis streams for conversation history"},{"id":"redis-hashes-for-user-profiles","title":"Redis Hashes for User Profiles"},{"id":"redis-json-for-complex-state","title":"Redis JSON for Complex State"},{"id":"redis-sets-for-relationships-and-tags","title":"Redis Sets for Relationships and Tags"},{"id":"redis-vector-sets-for-semantic-search","title":"Redis Vector Sets for Semantic Search"},{"id":"redis-sorted-sets-for-rankings-and-priorities","title":"Redis Sorted Sets for Rankings and Priorities"}],"id":"redis-data-structures-for-agent-memory","title":"Redis data structures for agent memory"},{"children":[{"id":"error-handling","title":"Error handling"},{"id":"retry-logic","title":"Retry logic"},{"id":"logging-and-monitoring","title":"Logging and monitoring"},{"id":"performance-optimization","title":"Performance optimization"}],"id":"reliability-features","title":"Reliability features"},{"children":[{"id":"monitoring-and-observability","title":"Monitoring and Observability"},{"id":"security-and-privacy","title":"Security and Privacy"},{"id":"scaling-strategies","title":"Scaling Strategies"},{"id":"cost-optimization","title":"Cost Optimization"}],"id":"production-deployment-considerations","title":"Production deployment considerations"},{"id":"key-takeaways","title":"Key takeaways"},{"id":"next-steps","title":"Next steps"}]}
...
![images/ai_agent/ai-agent-architecture-diagram.svg](https://redis.io/docs/latest/images/ai_agent/ai-agent-architecture-diagram.svg)

### The agent processing cycle

Every user interaction follows a 6-step cycle that makes agents intelligent:

![images/ai_agent/simple-processing-cycle.svg](https://redis.io/docs/latest/images/ai_agent/simple-processing-cycle.svg)
...
- [Learn more about Redis Vector Search →](https://redis.io/docs/latest/develop/ai/search-and-query/vectors/)
...
- [Learn about Redis Vector Sets →](https://redis.io/docs/latest/develop/data-types/vector-sets)
...
- [Learn about Redis scaling →](https://redis.io/docs/latest/operate/rs/clusters)
...
- [Redis performance optimization →](https://redis.io/docs/latest/operate/rs/databases/memory-performance)
...
**Get started:**
- [Use the agent builder](https://redis.io/docs/latest/develop/ai/agent-builder) to generate your code and get started
- [Redis quick start guide](https://redis.io/docs/latest/develop/get-started) for setting up Redis

**Learn more:**
- [Redis Vector Search documentation](https://redis.io/docs/latest/develop/ai/search-and-query/vectors)
- [RedisVL Python library](https://redis.io/docs/latest/develop/clients/redis-vl) for vector operations and AI workflows
- [Redis data structures guide](/develop/data-types/)
- [Redis client libraries](https://redis.io/docs/latest/develop/clients) for your programming language

**Deploy and scale:**
- [Redis Cloud](https://redis.io/docs/latest/operate/rc) for managed Redis hosting
- [Redis Software](https://redis.io/docs/latest/operate/rs) for on-premises deployment
- [Performance optimization](https://redis.io/docs/latest/operate/rs/databases/memory-performance) best practices
