...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"get-started","title":"Get started"},{"id":"what-are-ai-agents","title":"What are AI agents?"},{"id":"what-you-can-build","title":"What you can build"},{"id":"features","title":"Features"},{"id":"after-you-generate-your-code","title":"After you generate your code"},{"children":[{"id":"ai-agent-resources","title":"AI agent resources"},{"id":"redis-ai-documentation","title":"Redis AI documentation"},{"id":"for-experienced-developers","title":"For experienced developers"},{"id":"community-and-support","title":"Community and support"}],"id":"learn-more","title":"Learn more"}]}
...
Agents use Redis for data storage, [vector search](https://redis.io/docs/latest/develop/get-started/vector-database), and [conversation memory](https://redis.io/docs/latest/develop/get-started/rag). The interactive builder generates code in your preferred programming language with your choice of model.
...
- [Redis Vector Search](https://redis.io/docs/latest/develop/ai/search-and-query/vectors/) - Semantic search capabilities 
- [Redis Streams](/develop/data-types/streams/) - Real-time data and conversation history
- [AI Notebooks Collection](https://redis.io/docs/latest/develop/ai/notebook-collection) - Interactive tutorials and examples 
- [Ecosystem Integrations](https://redis.io/docs/latest/develop/ai/ecosystem-integrations) - Redis with AI frameworks
...
- [Redis Context Engine](https://redis.io/docs/latest/develop/ai/context-engine) — Managed services for agent memory, semantic caching, and structured data access (Redis Iris)
...
- Watch [AI Video Collection](https://redis.io/docs/latest/develop/ai/ai-videos) for tutorials and demonstrations
