...
Portado de LEGADO/agente-julio/src/pedidos.py (2026-07-22) — continua
escrevendo no MESMO arquivo (config.PEDIDOS_FUTUROS aponta pra
LEGADO/agente-julio/pedidos-futuros.md) pra nao fragmentar o backlog que
ja tem pedidos reais registrados.
"""
