"""Chama os outros agentes (ainda em LEGADO/, ate a Fase 1 do plano skill-ificar).

Cada agente e um processo Python independente com seu proprio .env e
dependencias — nao importamos o codigo deles diretamente (evitaria um
conflito de pacote entre modulos irmaos) nem precisamos saber como cada um
...
Portado de LEGADO/agente-julio/src/agentes.py (2026-07-22), so trocando os
caminhos de main.py pra apontar pra LEGADO/.
"""
import json
import os
import subprocess
