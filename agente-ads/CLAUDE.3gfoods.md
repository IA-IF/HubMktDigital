...
- Ecommerce de alimentos, site https://loja.3gfoods.com.br/ — conta Google Ads "3G Foods"
  (`758-019-9564`, já existente, MCC 890-192-5637) — **ajuste ticket médio e margem abaixo**
...
efetivos vêm do `.env.3gfoods` (o modelo recomenda, o código impõe):
