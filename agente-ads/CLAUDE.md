...
- Ecommerce de alimentos, site https://integrafoods.ind.br/ — conta Google Ads "Integra Foods V2"
  (`332-316-6484`, criada 22/07/2026, MCC 890-192-5637) — **ajuste ticket médio e margem abaixo**
...
efetivos vêm do `.env` (o modelo recomenda, o código impõe):
